      ...
      <div className={"p-4"} id={"prices"}>
        ...
        <div className={" my-8 p-4 grid grid-cols-1 gap-4 md:grid-cols-3"}>
          <PriceSection
            ...
            priceClass={
              localization.landingPage.body.price.free.subTitle[language]
            }
            priceClassDesc={
              localization.landingPage.body.price.free.desc[language]
            }
            buttonText={
              localization.landingPage.body.price.free.button[language]
            }
            featureList={
              localization.landingPage.body.price.free.features[language]
            }
            onClick={() => {
          ...
          <PriceSection
            ...
            priceClass={
              localization.landingPage.body.price.medium.subTitle[language]
            }
            priceClassDesc={
              localization.landingPage.body.price.medium.desc[language]
            }
            buttonText={
              localization.landingPage.body.price.medium.comingSoon[language]
            }
            featureList={
              localization.landingPage.body.price.medium.features[language]
            }
            onClick={() => {
              router.push("/signin");
            }}
          ...
          <PriceSection
            ...
            priceClass={
              localization.landingPage.body.price.large.subTitle[language]
            }
            priceClassDesc={
              localization.landingPage.body.price.large.desc[language]
            }
            buttonText={
              localization.landingPage.body.price.large.comingSoon[language]
            }
            featureList={
              localization.landingPage.body.price.large.features[language]
            }
            onClick={() => {
              // router.push("/signin");
            }}
...
interface PriceSection {
  price: string;
  colorVariant: "default" | "highlight";
  priceClass: string;
...
const PriceSection = ({
  ...
  const isDefault = colorVariant === "default";
    ...
    >
      ...
      <div
        className={`mt-1 text-base ${
          isDefault ? "text-sky-700" : "text-sky-200"
        }`}
      >
        {priceClassDesc}
      </div>
